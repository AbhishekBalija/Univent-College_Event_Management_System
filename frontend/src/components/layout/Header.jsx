        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            ...
            <Link to="/home" className="text-2xl font-bold flex items-center">
              <img src="/logo2.jpg" alt="Univent Logo" className="h-8 w-8 rounded-full mr-2" />
              <span>Univent</span>
            </Link>
          </div>
            ...
            {user ? (
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 font-medium hidden md:inline">{user.firstName || 'User'}</span>
                </div>
                <button 
                  onClick={handleLogout}
                  className="bg-white/10 hover:bg-white/20 px-4 py-2 rounded-md transition duration-300 border border-white/20"
                >
              ...
              <>
                ...
                <Link to="/register" className="bg-white text-blue-600 px-4 py-2 rounded-md hover:bg-blue-50 transition duration-300 font-medium">Register</Link>
              </>
            )}
          </div>
        </div>
