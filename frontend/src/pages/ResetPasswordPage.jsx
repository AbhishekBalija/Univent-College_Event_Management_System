          ...
          <div className="w-full md:w-1/2 p-8 lg:p-16 flex flex-col justify-center">
            <div className="max-w-md mx-auto w-full">
              <div className="mb-10 text-center">
                <h2 className="text-4xl font-extrabold text-gray-900 mb-2">Set a New Password</h2>
                <p className="text-gray-500">Choose a strong password to protect your account</p>
              </div>
              <ResetPasswordForm />
